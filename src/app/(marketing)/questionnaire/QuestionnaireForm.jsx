          ...
          <FieldGroup>
              ...
              <Field>
                ...
                <RadioGroup name="objectifSite">
                  <RadioField>
                    ...
                    <Description>
                      Un site simple et professionnel pour montrer qui vous
                      êtes, vos services et rassurer vos clients.
                    </Description>
                  </RadioField>
                  <RadioField>
                    <Radio value="pro" />
                    <Label>
                      Booster de Prospects : Transformez vos visiteurs en
                      contacts qualifiés et obtenez plus de demandes de devis.
                    </Label>
                    <Description>
                      Parfait pour développer votre activité ! Inclut un blog
                      pour partager votre expertise et des formulaires avancés
                      pour capter l'intérêt de vos prospects.
                    </Description>
                  </RadioField>
                  <RadioField>
                    <Radio value="premium" />
                    <Label>
                      E-commerce Puissant : Lancez et développez votre boutique
                      en ligne pour vendre vos produits sans limite.
                    </Label>
                    <Description>
                      Idéal pour les entreprises souhaitant vendre directement
                      en ligne. Bénéficiez d'une boutique performante avec
                      gestion des produits, des paiements sécurisés et bien plus
                      encore.
                    </Description>
                  </RadioField>
                </RadioGroup>
            ...
            {step === 3 && (
              <Field>
                ...
                <Textarea name="cible" />
                <Description>
                  Imaginez votre visiteur idéal... Quel âge a-t-il ? Quel est
                  son métier ? Quels sont ses besoins et ses centres d'intérêt ?
                  Où habite-t-il ? Plus vous nous donnez de détails, mieux nous
                  pourrons concevoir un site qui lui parle directement. Exemple
                  : "Jeunes professionnels de 30-45 ans à Paris, intéressés par
                  les solutions de gestion de projet innovantes.
                </Description>
              </Field>
            )}
            ...
            {step === 4 && (
              <Field>
                ...
                <Description>
                  ...
                  concurrents directs principaux ou qui sont considérés comme
                  des leaders dans votre domaine d'activité en ligne. Cela nous
                  aidera à comprendre le paysage concurrentiel.
                </Description>
              </Field>
            )}
              ...
              <Field>
                ...
                <Select name="identiteVisuelle">
                  ...
                  <option value="partial">
                    Partiellement (logo seulement)
                  </option>
                  <option value="no">
                    Non, je n’ai pas d’identité visuelle
                  </option>
                </Select>
                <Description>
            ...
            {step === 6 && (
              <Field>
                ...
                <Description>
                  Notre équipe de professionnels peut créer des textes
                  percutants et optimisés pour le référencement (SEO) qui
                  captiveront vos visiteurs. Si vous préférez écrire votre
                  propre contenu, nous l'intégrerons avec plaisir.
                </Description>
              </Field>
            )}
              ...
              <Field>
                ...
                <CheckboxGroup>
                  ...
                  <CheckboxField>
                    ...
                    <Label>
                      Boutique en ligne / Paiement sécurisé : Vendez vos
                      produits ou services directement en ligne en toute
                      confiance.
                    </Label>
                  </CheckboxField>
                  <CheckboxField>
                    ...
                    <Label>
                      Espace client sécurisé : Offrez un accès personnalisé à
                      vos clients.
                    </Label>
                  </CheckboxField>
                  <CheckboxField>
                  ...
                  <CheckboxField>
                    ...
                    <Label>
                      Intégration Newsletter / CRM : Gérez facilement vos
                      contacts et vos campagnes marketing.
                    </Label>
                  </CheckboxField>
                  <CheckboxField>
            ...
            {step === 9 && (
              <Field>
                ...
                <Description>
                  ...
                  l'utiliserons. Sinon, la création d'un nom de domaine
                  pertinent est incluse dans votre offre Klyx.
                </Description>
              </Field>
            )}
