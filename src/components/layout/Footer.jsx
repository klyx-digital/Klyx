const navigation = {
  main: [
    ...
    { name: "Pourquoi Klyx ?", href: "/why-klyx" },
    { name: "Blog", href: "/blog" },
  ],
  social: [
    {
      name: "Facebook",
      href: "https://www.facebook.com/profile.php?id=61575877903284",
      icon: (props) => (
    ...
    <footer className="bg-gray-900">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <div className="mt-16 border-t border-white/10 pt-8 sm:mt-20 lg:mt-24 lg:flex lg:items-center lg:justify-between">
          <div>
            <h3 className="text-sm/6 font-semibold text-white">
              Restez à la pointe du web&nbsp;: inscrivez-vous à notre newsletter{" "}
            </h3>
            <p className="mt-2 text-sm/6 text-gray-300 max-w-2xl">
              Conseils, actus, et astuces pour booster votre présence en
              ligne&nbsp;: recevez chaque semaine le meilleur du digital
        ...
        <p className="mt-10 text-center text-sm/6 text-gray-400">
          &copy; 2025 Klyx – Création de sites web sur-mesure. Tous droits
          réservés.
        </p>
      </div>
    </footer>
